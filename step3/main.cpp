...
int main(int argc, char **argv)
{
  ...
  std::vector<vec4> tmp_com(N);
  #pragma acc enter data create(tmp_com.data()[N])
  ...
  centerOfMassGPU(*particles[steps & 1ul], tmp_com.data(), N);
  #pragma acc update host(tmp_com.data()[1])
  vec4 comOnGPU = tmp_com[0];
  ...
  #pragma acc exit data delete(tmp_com.data()[N])
